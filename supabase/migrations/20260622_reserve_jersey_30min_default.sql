-- Task #35: reservation hold is documented/intended as 30 minutes, but the
-- column default and reserve_jersey's p_expires_minutes default were left at 15.
-- The widget always passes expiresMinutes:30 explicitly, so this only matters
-- as a latent fallback inconsistency for any caller that omits it.
